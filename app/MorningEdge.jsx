    ...
    <div className="min-h-screen relative overflow-hidden" style={{
      ...
      {brief && (
        ...
        >
          ...
          {visible.decisions && brief.decisions && (
          ...
          {visible.conviction && brief.conviction_watch && (
...
function SmartMoneyRow({ item, onOpenLink }) {
  ...
  return (
    <li className="text-[16px] flex items-start gap-2 px-2 py-1.5 -mx-2">{RowInner}</li>
  );
}
  ...
  return (
    <div className="fixed inset-0 z-50 bg-white flex flex-col">
      ...
      <div className="flex-1 relative overflow-hidden">
        ...
        <button
          onClick={onClose}
          className="fixed bottom-6 left-1/2 -translate-x-1/2 px-6 py-3 rounded-full bg-slate-900 text-white text-[16px] font-semibold shadow-2xl flex items-center gap-2 hover:bg-slate-800 active:bg-slate-700 transition z-10"
        ...
        {loadFailed && !loadAttempted && (
          <div className="absolute inset-0 bg-white flex flex-col items-center justify-center px-6 text-center">
            ...
            <p className="text-[16px] text-slate-700 max-w-sm leading-relaxed mb-5">
            ...
            {autoOpened && (
              <button
                onClick={onClose}
                className="px-5 py-2.5 rounded-xl bg-slate-900 text-white text-[16px] font-semibold hover:bg-slate-800 active:bg-slate-700 transition flex items-center gap-2"
              >
                <ChevronLeft className="w-4 h-4" /> Back to Morning Edge
              </button>
            )}
            {!autoOpened && (
              <button
                onClick={onClose}
                className="text-[13px] text-slate-700 hover:text-slate-700"
              >
                Cancel
              </button>
            )}
