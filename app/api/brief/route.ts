...
Return ONLY: { "affirmation": "max 12 words", "mindset": { "gratitude": "max 18 words Stoic voice", "fuel": { "headline": "max 14 words", "total_min": 10, "blocks": [ { "name": "Mobility (2 min)", "moves": ["3-4"], "why": "1 sentence" }, { "name": "Breathwork (3 min)", "moves": ["2-3"], "why": "1 sentence" }, { "name": "Strength (3 min)", "moves": ["3-4"], "why": "1 sentence" }, { "name": "Cooldown (2 min)", "moves": ["2-3"], "why": "1 sentence" } ], "tip": "1-2 sentences" }, "focus": "max 10 words" }, "clarity": { "contemplation": "max 22 words", "eastern_wisdom": { "quote": "real", "source": "X" }, "breath_practice": { "name": "X", "pattern": "timing", "description": "max 24 words", "rounds": "X" } }, "power_plate": { "name": "max 6 words (real dish or ingredient-led title — never clinical/pharmaceutical/chemical-sounding)", "style": "Mediterranean", "protein_g": 30, "prep_min": 25, "description": "4-5 sentences", "why_this_meal": "120-170 words", "groceries": ["7-10"], "prep_steps": ["7-9 steps"], "swap_options": ["3-4"], "pairing": "2-3 sentences" }, "decisions": ["8-10"], "decisions_reasoning": ["each 130-180 words"] }
${accountRule}
